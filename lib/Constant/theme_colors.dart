...
class ThemeColors {
  ...
  static const Color blackColor = Color(0xFF0C0B0C);
  ...
  static const Color greyBackgrounColor = Color(0xFFD5D5D5);
  ...
  static const Color functionbuttonColor = Color(0xff1A3A6B);
  static const Color defaultbuttonColor = Color(0xff1A3A6B);
