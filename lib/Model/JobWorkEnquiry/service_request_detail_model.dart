class JobWorkEnquiryServiceRequestDetailRepo {
  bool? success;
  ...
  JobWorkEnquiryServiceRequestDetailRepo(
      {this.success,
  ...
  factory JobWorkEnquiryServiceRequestDetailRepo.fromJson(Map<dynamic, dynamic> json) {
    try {
      return JobWorkEnquiryServiceRequestDetailRepo(
...
class JobWorkEnquiryDetailsModel {
  int? id;
  ...
  JobWorkEnquiryDetailsModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
