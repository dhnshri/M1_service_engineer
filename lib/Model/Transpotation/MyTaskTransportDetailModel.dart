class MyTaskTransportDetailRepo {
  bool? success;
  ...
  factory MyTaskTransportDetailRepo.fromJson(Map<dynamic, dynamic> json) {
    try {
      return MyTaskTransportDetailRepo(
...
class TransportMyTaskDetailsModel {
  ...
  TransportMyTaskDetailsModel.fromJson(Map<String, dynamic> json) {
