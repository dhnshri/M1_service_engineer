...
// Job wprk enquiry Quotation Reply
    ...
    Future<dynamic> fetchRejectRevised(
        {String? machineEnquiryId, String? serviceUserId, String? jobWorkEnquiryId, String? transportEnquiryId, String? status}) async {
      final params = {
        "machine_enquiry_id": machineEnquiryId,
    ...
    Future<dynamic> fetchServiceRequestDetail(
        {String? userID, String? machineEnquiryId,
    ...
    Future<dynamic> fetchTrackProgressList(
        {String? userId, String? machineEnquiryId, String? jobWorkWnquiryId, String? transportEnquiryId}) async {
      final params = {
    ...
    Future<dynamic> createTask(
        {String? userId, String? machineEnquiryId, String? jobWorkWnquiryId, String? transportEnquiryId, String? heading, String? description, int? status}) async {
      final params = {
        "service_user_id": userId,
        'machine_enquiry_id': machineEnquiryId,
        'job_work_enquiry_id': jobWorkWnquiryId,
    ...
    Future<dynamic> completeTask(
        {String? serviceUserId, String? machineEnquiryId, String? jobWorkWnquiryId, String? transportEnquiryId, String? dailyTaskId, int? status}) async {
      final params = {
        "service_user_id": serviceUserId,
        'machine_enquiry_id': machineEnquiryId,
        'job_work_enquiry_id': jobWorkWnquiryId,
    ...
    Future<dynamic> SendQuotationPara(
        {String? serviceUserId, String? workingTime, String? dateOfJoining, String? serviceCharge, String? handlingCharge, String? transportCharge,
          List<ProductListModel>? itemList, List<
            ProductNotAvailableListModel>? itemNotAvailableList, String? commission, String? machineEnqDate, String? machineEnqId}) async {
