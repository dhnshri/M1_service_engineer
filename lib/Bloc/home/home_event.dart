...
class TransporGetTrackProcess extends HomeEvent {

  String serviceUserID,transportEnquiryId;

  TransporGetTrackProcess({required this.serviceUserID,required this.transportEnquiryId,});
}
