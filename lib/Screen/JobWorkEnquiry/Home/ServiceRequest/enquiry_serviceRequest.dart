...
class EnquiryServiceRequestScreen extends StatefulWidget {
  EnquiryServiceRequestScreen({Key? key, required this.isSwitched})
      : super(key: key);
  bool isSwitched;
...
class _EnquiryServiceRequestScreenState
  ...
  getApi() {
    _homeBloc!
        .add(OnServiceRequestJWEList(offSet: '$offset', timePeriod: '$timeId'));
  }
  ...
  void searchOperation(String searchText) {
    ...
    if (_isSearching != null) {
      for (int i = 0; i < serviceJobWorkEnquiryList.length; i++) {
        JobWorkEnquiryServiceRequestModel serviceListData =
            new JobWorkEnquiryServiceRequestModel();
        serviceListData.itemName =
            serviceJobWorkEnquiryList[i].itemName.toString();
  ...
  Widget buildJobWorkEnquiriesList(
      List<JobWorkEnquiryServiceRequestModel> jobWorkEnquiryList) {
              ...
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) => EnquiryServiceRequestDetailsScreen(
                            serviceRequestData: jobWorkEnquiryList[index],
                          )));
            },
  ...
  Widget serviceRequestCard(BuildContext context,
    ...
    return Scaffold(
      ...
      return BlocListener<HomeBloc, HomeState>(
        ...
        child: widget.isSwitched
            ? _loadData
                ? serviceJobWorkEnquiryList.length <= 0
                    ? Center(
                        child: Text('No Data'),
                      )
                    : Column(
                        children: [
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Expanded(
                                            // width:200,
                                            child: const Text(
                                                "Task Assigned By Other Service Providers",
                                                overflow: TextOverflow.ellipsis,
                                                maxLines: 2,
                                                style: TextStyle(
                          ...
                          flagSearchResult == false
                              ? (searchResult.length != 0 ||
                                  ...
                                  ? Expanded(
                                      child: buildJobWorkEnquiriesList(
                                          searchResult))
                                  : Expanded(
                                      child: buildJobWorkEnquiriesList(
                                          serviceJobWorkEnquiryList))
