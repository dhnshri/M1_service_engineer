...
class EnquiryServiceRequestDetailsScreen extends StatefulWidget {
  ...
  EnquiryServiceRequestDetailsScreen(
      {Key? key, required this.serviceRequestData})
      : super(key: key);

  @override
  _EnquiryServiceRequestDetailsScreenState createState() =>
      _EnquiryServiceRequestDetailsScreenState();
}

class _EnquiryServiceRequestDetailsScreenState
    extends State<EnquiryServiceRequestDetailsScreen> {
  ...
  void initState() {
    ...
    _homeBloc!.add(OnServiceRequestJobWorkEnquiryDetail(
        userID: '100',
        machineEnquiryId: '0',
        jobWorkEnquiryId: '13',
    ...
    return Scaffold(
            ...
            children: [
              Flexible(
                child: AppButton(
                  ...
                  borderColor: ThemeColors.defaultbuttonColor,
                  textColor: ThemeColors.defaultbuttonColor,
                ),
              ),
              ...
              Flexible(
                child: AppButton(
                  onPressed: () async {
                    serviceRequestDetailData!.isEmpty
                        ? null
                        : Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) =>
                                    EnquiryMakeQuotationScreen(
                                      requestDetailList:
        ...
        body: BlocBuilder<HomeBloc, HomeState>(builder: (context, state) {
          return BlocListener<HomeBloc, HomeState>(
              ...
              child: _isLoading
                  ? serviceRequestDetailData!.length <= 0
                      ? Center(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          Text(
                                            "Enquiry Last Date Closed:",
                                            style: ExpanstionTileLeftDataStyle,
                                          ),
                                          Text(
                                            serviceRequestDetailData![0]
                                                .projectComplitionDate
                                                .toString(),
                                            style: ExpanstionTileRightDataStyle,
                                          ),
                                        ],
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              Text(
                                                "Item Name:",
                                                style:
                                                    ExpanstionTileLeftDataStyle,
                                              ),
                                              Text(
                                                serviceRequestDetailData![index]
                                                    .itemName
                                                    .toString(),
                                                style:
