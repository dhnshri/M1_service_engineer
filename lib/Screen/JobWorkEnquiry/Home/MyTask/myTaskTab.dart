...
class _EnquiryMyTaskScreenState extends State<EnquiryMyTaskScreen> {
  ...
  void searchOperation(String searchText) {
    ...
    if (_isSearching != null) {
      for (int i = 0; i < myTaskJobWorkEnquiryList.length; i++) {
        JobWorkEnquiryMyTaskModel taskListData =
            new JobWorkEnquiryMyTaskModel();
        ...
        if (taskListData.itemName
                .toString()
                .toLowerCase()
                .contains(searchText.toLowerCase()) ||
            taskListData.enquiryId
                .toString()
                .toLowerCase()
                .contains(searchText.toLowerCase()) ||
            taskListData.dateAndTime
                .toString()
                .toLowerCase()
                .contains(searchText.toLowerCase())) {
  ...
  Widget buildmyTaskJobWorkEnquiryList(
      List<JobWorkEnquiryMyTaskModel> myTaskJobWorkEnquiryList) {
              ...
              Navigator.pushReplacement(
                  ...
                  MaterialPageRoute(
                      builder: (context) => EnquiryMyTaskDetailsScreen(
                            myTaskJobWorkEnquiryData:
                                myTaskJobWorkEnquiryList[index],
                          )));
            },
  ...
  Widget myTaskCard(BuildContext context,
      JobWorkEnquiryMyTaskModel jobWorkEnquiryMyTaskData) {
    return Container(
                        ...
                        Container(
                          child: Text(
                            DateFormat('MM-dd-yyyy h:mm a')
                                .format(DateTime.parse(jobWorkEnquiryMyTaskData
                                    .dateAndTime
                                    .toString()))
                                .toString(),
                            style: TextStyle(
    ...
    return Scaffold(
      ...
      return BlocListener<HomeBloc, HomeState>(
        ...
        child: widget.isSwitched
            ? _loadData
                ? myTaskJobWorkEnquiryList.length <= 0
                    ? Center(
                        child: Text('No Data'),
                      )
                    : Container(
                          ...
                          children: [
                                    ...
                                    InkWell(
                                      onTap: () async {
                                        ...
                                        if (filterResult != null) {
                                          myTaskJobWorkEnquiryList =
                                              filterResult['taskList'];
                            ...
                            flagSearchResult == false
                                ? (searchResult.length != 0 ||
                                    ...
                                    ? Expanded(
                                        child: buildmyTaskJobWorkEnquiryList(
                                            searchResult))
                                    : Expanded(
                                        child: buildmyTaskJobWorkEnquiryList(
                                            myTaskJobWorkEnquiryList),
