...
import 'package:service_engineer/Screen/JobWorkEnquiry/HandOver%20Task%20List/handover_task_detail.dart';
...
class JobWorkHandOverTaskList extends StatefulWidget {
  ...
  @override
  _JobWorkHandOverTaskListState createState() =>
      _JobWorkHandOverTaskListState();
}

class _JobWorkHandOverTaskListState extends State<JobWorkHandOverTaskList> {
        ...
        ..addListener(() {
          if (_scrollController.position.pixels ==
            ...
            BlocProvider.of<HomeBloc>(context)
              ..isFetching = true
              ..add(OnServiceRequest(
                  timeId: timeId.toString(), offSet: offSet.toString()));
