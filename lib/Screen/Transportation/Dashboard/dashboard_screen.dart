...
class TransportDashboardScreen extends StatefulWidget {
  const TransportDashboardScreen({Key? key}) : super(key: key);

  @override
  _DashboardState createState() => _DashboardState();
}

class _DashboardState extends State<TransportDashboardScreen> {
  ...
  void initState() {
    ...
    _dashboardBloc!.add(GetTransportDashboardCount(
