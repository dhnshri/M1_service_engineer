...
class _OrderItemDetailsScreenState extends State<OrderItemDetailsScreen> {
  ...
  void initState() {
    ...
    _orderBloc!.add(GetOrderDetail(
        serviceUserId: widget.orderList.serviceUserId.toString(),
        machineEnquiryId: widget.orderList.machineEnquiryId.toString()));
    _orderBloc!.add(OnServiceRequestDetail(
        userID: widget.orderList.serviceUserId.toString(),
        machineEnquiryId: widget.orderList.machineEnquiryId.toString(),
        jobWorkEnquiryId: '0',
        transportEnquiryId: '0'));
  }

  TotalAmount() {
    grandTotal = itemRequiredTotal +
        itemOthersTotal +
        double.parse(orderDetail[0].serviceCharge.toString()) +
        double.parse(orderDetail[0].transportCharge.toString()) +
        double.parse(orderDetail[0].handlingCharge.toString()) +
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                    "₹ ${itemRequiredTotal + itemOthersTotal}"),
                                              ],
                                            ),
                                            SizedBox(
                                              height: 10,
                                  ...
                                  Container(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          QrImage(
                                            data: "Generate Qr Code",
                                            size: 130,
                                          ),
                                        ],
                                      )),

                                  (widget.orderList.cancelOrder != 1 &&
                                          widget.orderList
                                                  .orderTrackingStatus !=
                                              5)
                                      ? Padding(
                                                                  ...
                                                                  children: [
                                                                    TextButton(
                                                                        ...
                                                                        style: TextButton.styleFrom(
                                                                            side:
                                                                                BorderSide(color: ThemeColors.defaultbuttonColor, width: 1.5))),
                                                                    SizedBox(
                                                                      width: 7,
                                                                    ),
                                                                    TextButton(
                                                                      ...
                                                                      onPressed:
                                                                          () {
                                                                        _orderBloc!.add(CancelOrder(
                                                                            serviceUserId:
                                                                                widget.orderList.serviceUserId.toString(),
                                                                            machineEnquiryId: widget.orderList.machineEnquiryId.toString()));
                                                                      },
                                                                      style: TextButton.styleFrom(
                                                                          backgroundColor:
  ...
  List<StepperData> stepperData = [
    ...
    StepperData(
        title: StepperText(
            "Order is reached your location\nplease verify and recive",
            textStyle: TextStyle(
                fontSize: 13,
                fontFamily: 'Poppins',
                fontWeight: FontWeight.w500)),
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [Text("Product Name or Any...")],
                  ),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [Text("5")],
