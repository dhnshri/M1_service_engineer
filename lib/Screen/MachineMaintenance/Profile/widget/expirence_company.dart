      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            ///Job Post in the Company
            TextFormField(
              // initialValue: Application.customerLogin!.name.toString(),
              controller: widget._jobPostController,
              textAlign: TextAlign.start,
              keyboardType: TextInputType.text,
              style: TextStyle(
                fontSize: 18,
              ...
              decoration: InputDecoration(
                filled: true,
                fillColor: ThemeColors.textFieldBackgroundColor,
                hintText: "Job Post in the Company",
                contentPadding: EdgeInsets.symmetric(
                    vertical: 10.0, horizontal: 15.0),
                hintStyle: TextStyle(fontSize: 15),
                enabledBorder: OutlineInputBorder(
              ...
              validator: (value) {
                ...
                if (value == null || value.isEmpty) {
                  return 'Please enter Job Post in the Company';
                }
              ...
              onSaved: (value) => widget.expCompanyModel!.jobPost = value!,

              onChanged: (value) {
                widget.expCompanyModel!.jobPost = value;
                setState(() {
                  // _nameController.text = value;
                  if (formKey.currentState!.validate()) {}
                });
